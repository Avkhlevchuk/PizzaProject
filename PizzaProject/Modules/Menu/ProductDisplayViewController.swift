...
final class ProductDisplayViewController: UIViewController {
...
extension ProductDisplayViewController {
...
extension ProductDisplayViewController {
    private func setupBinding() {
        ...
        productViewModel.onCartUpdate = { [weak self] in
            guard let self = self else { return }
            if let totalPrice = productViewModel.totalPriceCart {
...
extension ProductDisplayViewController: UITableViewDataSource, UITableViewDelegate {
